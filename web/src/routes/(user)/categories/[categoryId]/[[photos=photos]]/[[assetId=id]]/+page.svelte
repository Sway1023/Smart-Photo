...
<UserPageLayout hideNavbar showTopBar title={data.meta.title} scrollbar={false}>
  {#snippet topbar()}
    {#if assetInteraction.selectionActive}
    ...
    {:else}
      <ControlAppBar showBackButton backIcon={mdiArrowLeft} onClose={() => goto(Route.categories())} />
    {/if}
  {/snippet}
