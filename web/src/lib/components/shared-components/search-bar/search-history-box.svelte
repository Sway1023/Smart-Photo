...
<div role="listbox" {id} aria-label={$t('recent_searches')} bind:this={element}>
  {#if isOpen && isSearchSuggestions}
    <div
      ...
      class="absolute z-50 w-full rounded-b-xl border border-t-0 border-[#D4D4D9] bg-white pb-5 shadow-[0_24px_60px_rgba(15,23,42,0.12)] transition-all dark:border-gray-700 dark:bg-immich-dark-gray dark:text-gray-300"
    >
